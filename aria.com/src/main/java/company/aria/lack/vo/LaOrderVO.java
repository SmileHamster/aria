...
public class LaOrderVO {
	...
	public int getLo_ls_storeNo() {
		return lo_ls_storeNo;
	}
	public void setLo_ls_storeNo(int lo_ls_storeNo) {
		this.lo_ls_storeNo = lo_ls_storeNo;
	}
