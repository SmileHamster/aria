...
//	json = JSON.parse(json);
	...
	<br><br><br>
	<form>
	<a href="${contextPath }/bupage/addAllStore.do">전체 등록하기</a>
	<table>
		<tr bgcolor="#afa">
			<td>상호명</td>
			<td>도로명주소</td>
			...
			<td>연락처</td>
			<td>업데이트기준</td>
	<c:forEach var="list" items="${common_api_list}">
		<tr>
			<td><a href="${contextPath }/bupage/addStore.do?mrhstNm=${list.mrhstNm }">${list.mrhstNm }</a></td>
			<td>${list.rdnmadr }</td>
			<td>${list.lnmadr }</td>
